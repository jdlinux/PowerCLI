...
$report | Export-Csv C:\Users\jdeblois\OneDrive - Versatile Communications\Documents\BILPHN\VNX_Unisphere\VNX_Unisphere_VMs.csv -NoTypeInformation -UseCulture